...
"use strict";jQuery(document).ready(function(e){e(".live-search-list li").each(function(){e(this).attr("data-search-term",e(this).text().toLowerCase())}),e(".live-search-box").on("keyup",function(){var t=e(this).val().toLowerCase();e(".live-search-list li").each(function(){0<e(this).filter("[data-search-term *= "+t+"]").length||t.length<1?e(this).show():e(this).hide()})})});
...
var map = L.map('mapid_2').setView([51.5, -0.09], 13);
  ...
  var greenIcon = new LeafIcon({iconUrl: '../assets/images/map-pin.png'}),
   ...
   L.marker([51.5, -0.09], {icon: greenIcon}).bindPopup('<div class="tooltip-block"><div class="tooltip-img"><a href="#"><img src="../assets/images/tooltip-img-1.jpg" alt="" class="img-fluid"></a></div><div class="tooltip-content"><h3 class="tooltip-content-title"><a href="#" class="title">Beautiful Cozy Home</a></h3><p class="tooltip-content-text"><i class="mdi mdi-map-marker"></i>Madrid . Private Room</p><div class="review-content-rating"> <span class="mdi mdi-star mr-1 text-warning small"></span><span class="rating-review">4.9(6)</span></div></div></div>').addTo(map);
  L.marker([51.495, -0.083], {icon: redIcon}).bindPopup('<div class="tooltip-block"><div class="tooltip-img"><a href="#"><img src="../assets/images/tooltip-img-1.jpg" alt="" class="img-fluid"></a></div><div class="tooltip-content"><h3 class="tooltip-content-title"><a href="#" class="title">Beautiful Cozy Home</a></h3><p class="tooltip-content-text"><i class="mdi mdi-map-marker"></i>Madrid . Private Room</p><div class="review-content-rating"> <span class="mdi mdi-star mr-1 text-warning small"></span><span class="rating-review">4.9(6)</span></div></div></div>').addTo(map);
  L.marker([51.49, -0.1], {icon: orangeIcon}).bindPopup('<div class="tooltip-block"><div class="tooltip-img"><a href="#"><img src="../assets/images/tooltip-img-1.jpg" alt="" class="img-fluid"></a></div><div class="tooltip-content"><h3 class="tooltip-content-title"><a href="#" class="title">Beautiful Cozy Home</a></h3><p class="tooltip-content-text"><i class="mdi mdi-map-marker"></i>Madrid . Private Room</p><div class="review-content-rating"> <span class="mdi mdi-star mr-1 text-warning small"></span><span class="rating-review">4.9(6)</span></div></div></div>').addTo(map);
